...
ActiveRecord::Schema[7.0].define(version: 2023_06_06_194122) do
  ...
  create_table "followed_topics", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["follower_id"], name: "index_followed_topics_on_follower_id"
  ...
  add_foreign_key "followed_topics", "followers"
  add_foreign_key "followed_topics", "topics"
  add_foreign_key "followed_users", "followees"
  add_foreign_key "followed_users", "followers"
